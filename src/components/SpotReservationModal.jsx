...
export default function SpotReservationModal({ lot, isOpen, onClose, onReserve }) {
  ...
  const spotData = generateSpotData(selectedLevel);
        ...
        >
          <div className="p-6 border-b border-gray-200">
            <div className="flex justify-between items-center">
              <div>
                <h2 className="text-2xl font-bold text-gray-800">Reserve Parking Spot</h2>
          ...
          <div className="p-6 overflow-y-auto max-h-[calc(90vh-200px)]">
            ...
            <div className="mb-6">
              <div className="flex justify-between items-center mb-3">
                <h3 className="text-lg font-semibold">Available Spots - Level {selectedLevel}</h3>
            ...
            {selectedSpot && (
              ...
              >
                <h4 className="font-semibold text-blue-800 mb-2">Selected Spot Details</h4>
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <span className="text-gray-600">Spot Number:</span>
                    <span className="font-medium ml-2">{selectedSpot.number}</span>
                  </div>
                  <div>
                    <span className="text-gray-600">Level:</span>
                    <span className="font-medium ml-2">{selectedSpot.level}</span>
                  </div>
                  <div>
                    <span className="text-gray-600">Type:</span>
                    <span className="font-medium ml-2 capitalize">{selectedSpot.type}</span>
                  </div>
                  <div>
                    <span className="text-gray-600">Position:</span>
                    <span className="font-medium ml-2">Spot {selectedSpot.spot}</span>
                  </div>
                </div>
              </motion.div>
            )}
